 ...
 function Anubis() {
  ...
  function setKey(key, raw_key) {
	...
	function generateIV(iv) {
		return kdf(KDF_algo, iv, KDF_salt, 16);
	}
  ...
  function hash512(i){
	...
	return {
      ...
      enc: function(key, data, iv){
        return encrypt(key, data, iv);
      },
      dec: function(key, data){
        return decrypt(key, data);
      },
      encPbkf2: function(key,salt,rounds,length, data, iv){
        var result = crypto.pbkdf2Sync(key, salt, rounds, length, 'sha512');
        return encrypt(result, data, iv);
      },
      decPbkf2: function(key,salt,rounds,length, data){
        var result = crypto.pbkdf2Sync(key, salt, rounds, length, 'sha512');
...
//console.log("Encript: " + anubis.enc('secret_key','Hellow world', "6a28abc8be644423521a511c071b2a8e"));
//console.log("Decript: " + anubis.dec('secret_key', anubis.enc('secret_key','Hellow world', "6a28abc8be644423521a511c071b2a8e")));
//console.log("Encript2: " + anubis.encPbkf2('secretsecretsecretsecretsecretsecret', 'salt', 1000, 256, 'Hellow world', "6a28abc8be644423521a511c071b2a8ef"));
//console.log("Decript2: " + anubis.decPbkf2('secretsecretsecretsecretsecretsecret', 'salt', 1000, 256,  '1c9c15fae2105293885083e6f8ac59eee4f375313d8d219a7caa9a92b75fb938'));
